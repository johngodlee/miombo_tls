...
\subsection{Whole plot canopy complexity}
...
Where $G_{z}$ is the vertical height axis $z$, $x$ is the horizontal axis, and $\sigma{}$ is the standard deviation. Plot level canopy closure was calculated as the mean of subplot TLS canopy closure estimates. Plot level foliage density was calculated as the sum of filled 50 cm\textsuperscript{3} voxels above 1.3 m and below the 99th percentile of height.
