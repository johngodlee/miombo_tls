...
\begin{figure}[H]
\centering
	\includegraphics[width=\textwidth]{height_profile_mods_re}
	\caption{Random effects per plot, coloured by site, for the effect of neighbourhood species richness on various canopy structure metrics.}
	\label{height_profile_mods_re}
\end{figure}
